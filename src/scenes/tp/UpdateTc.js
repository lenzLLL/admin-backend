...
const UpdateTypeC = () => {
  ...
  const getPoste = async () =>{
    const q = query(collection(firestore, "typecourrier"), where("id", "==", JSON.parse(localStorage.getItem("ASYNC_ID"))));
    const table = []
  ...
  return (
    <Box m="20px">
      <Header title="Type courrier" subtitle="Modifier le type de courrier" />
